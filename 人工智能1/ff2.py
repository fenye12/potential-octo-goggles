...
# 加载数据集
train_data = datasets.ImageFolder(root=r"E:\flowerDataSet\Training", transform=transform)
val_data = datasets.ImageFolder(root=r"E:\flowerDataSet\Test", transform=transform)
